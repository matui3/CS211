...
// CS211, January 2023, W.P. Iverson, instructor
public class Post {
...
//		B.  Exercise #9   equals(t2);
		empty.add(.1);
		System.out.println(empty.equals(other)); // false
		empty.remove(.1);
		System.out.println(test.equals(test));	// true
		System.out.println(test.equals(other)); // false
		other.add(new CalendarDate(1,1,2021));  other.add(new CalendarDate(12,12,2016));
		System.out.println(test.equals(other)); // true
