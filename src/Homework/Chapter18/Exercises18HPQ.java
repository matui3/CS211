...
// Chapter 18 example, January 2022
public class Exercises18HPQ {
	...
	public static void main(String[] args) {
		...
		System.out.println(pq18.remove(42)); // removes just a single Object // Currently wrong needs to return true
		System.out.println(pq18); // uses PQ toString()
		System.out.println(pq18.remove(99)); // removes just a single Object // currently wrong needs to return false
		System.out.println(pq18); // uses PQ toString()
		System.out.println(pq18.poll()); // Oracle PQ actually uses poll to remove // looks like poll works...
		System.out.println(pq18); // uses PQ toString()
